...
struct ServiceDetailViewPrevision: View {
            ...
            .padding(.top, 20)
                ...
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    missionRow(
                        ...
                        text: "Gestion des consignes du Système de Gestion Opérationnelle"
                    )
                    missionRow(
                        icon: "checkmark.circle.fill",
                        text: "Administration de la DECI"
                    )
                    missionRow(
                        icon: "checkmark.circle.fill",
                        text: "Réalisation des documents de planification opérationnelle"
                    )
                    missionRow(
                        icon: "checkmark.circle.fill",
                        text: "Mise à jour des outils cartographiques"
                    )
                    missionRow(
                        icon: "checkmark.circle.fill",
                        text: "Proposer des sites de manœuvres"
                    )
                }
                .padding()
